...
"font: 9pt \"Calibri\";"));
        ...
        gridLayout_15->addWidget(externalTrigger, 3, 2, 1, 1);
        ...
        layoutWidget->setGeometry(QRect(10, 20, 410, 61));
        ...
        reconstructionCount->setEnabled(true);
